...
public class JetsonCacheTest {
  ...
  public void testBeanWithFields() throws Exception {
    ...
    //--- when
    List<JsonAccessor> accessors = JsonCache.getAccessors( BeanWithFields.class );
  ...
  public void testAnnotatedBeanNeverDecodes() throws Exception {
    //--- when
    List<JsonAccessor> accessors = JsonCache.getAccessors( AnnotatedBeanNeverDecodes.class );
