...
public class Jetson {
   ...
   * @throws ParseException in case of an error in the JSON string
   */
  public static Object decodeIntoObjectWithGeneric( String json, Object target,
      Class<?> genericType )
  ...
  /**
   * Skip encoding of values which are {@code null} or empty instead of encoding them.
   *
   * @return this for fluent API
   */
  public static JsonEncoder skipEmpty() {
    return JsonEncoder.encoder().skipEmpty();
  }

  /**
   * Skip encoding of values having a value of {@code null} instead of encoding them.
   *
   * @return this for fluent API
   */
  public static JsonEncoder skipNull() {
    return JsonEncoder.encoder().skipNull();
  }
}